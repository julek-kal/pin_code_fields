...
// selects the right fill color for the field
  ...
  Widget build(BuildContext context) {
    var textField = TextFormField(
      ...
      autofillHints:
          widget.enablePinAutofill && widget.enabled ? <String>[AutofillHints.oneTimeCode] : null,
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: GestureDetector(
                ...
                onDoubleTap: widget.enabled ? getClipboardDataAndShowPasteDialog : null,
                onLongPress: widget.enabled ? getClipboardDataAndShowPasteDialog : null,
                child: Row(
  ...
  getClipboardDataAndShowPasteDialog() async {
